...
int main(){	
	...
	if(playerAction == 1){
		...
		int card = drawCard();
  		playerScore = calScore(playerScore, card, 0);
		cout << "Player draws the 3rd card!!!" << "\n";
		cout << "Your 3rd card: " << cardNames[card]<<"\n";
	...
	if(yugiAction == 1){
		int card = drawCard();
  		yugiScore = calScore(yugiScore, card, 0);
		cout << "Yugi draws the 3rd card!!!\n";
		cout << "Yugi's 3rd card: " <<cardNames[card]<< "\n";
